...
if GEMINI_API_KEY:
    ...
    MODEL_LIST = ["gemini-1.5-flash-latest", "gemini-1.5-pro-latest", "gemini-2.0-flash-exp", "gemini-pro"]
    for m in MODEL_LIST:
        try:
...
async def main():
    ...
    print(f"\n🤖 EGX News Bot v5.1 Started | Model: {selected_model_name or 'N/A'} | Tracked: {len(sent_db)}")
