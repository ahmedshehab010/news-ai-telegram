...
async def analyze_news_with_gemini(title, description, tickers, fair_value_data):
    if not model:
        ...
        return "⚠️ نموذج الذكاء الاصطناعي غير متاح حالياً. يرجى التحقق من مفتاح API."
...
async def main():
    ...
    print(f"\n🤖 EGX News Bot v4.1 Started | Model: {selected_model_name or 'N/A'} | Tracked: {len(sent_db)}")
